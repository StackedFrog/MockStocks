...
function Register({ setLogin }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background text-text font-text">
      <div className="w-full max-w-sm p-6 rounded-2xl shadow-lg border border-border bg-white dark:bg-gray-900 dark:border-gray-700">
        <h1 className="text-2xl font-heading text-center mb-6">Register</h1>
        <form className="space-y-4" onSubmit={handleRegister}>
          <input
            type="text"
            placeholder="Name"
            onChange={(e) => setName(e.target.value)}
            className="w-full border border-border px-3 py-2 rounded outline-none focus:ring-2 focus:ring-primary bg-background text-text"
            required
          />
          <input
            type="email"
