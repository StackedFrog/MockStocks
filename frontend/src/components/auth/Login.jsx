      ...
      <div className="w-full max-w-sm p-6 rounded-2xl shadow-lg border border-border bg-white dark:bg-gray-900 dark:border-gray-700">
        ...
        <form id="login-form" className="space-y-4" onSubmit={handleLogin}>
          <input
            ...
            className={`w-full border px-3 py-2 rounded outline-none focus:ring-2 focus:ring-primary bg-background text-text ${loginFailed ? "border-red-500 text-red-500 animate-pulse" : "border-border"}`}
            required
          />
          <input
            type="password"
